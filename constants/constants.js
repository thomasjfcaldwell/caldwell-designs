export const process = [
	{
		...
		step: 'Step 1',
		description:
			'The start of possible Collaboration is the project request. Your info allows me to understand if I am the right fit for your project. If yes, I will arrange a call. If No, I will do my best to recommend someone that is',
		headline: 'Project Request',
	},
	{
		id: 1,
		step: 'Step 2',
	...
	},
	{
		...
		step: 'Step 3',
		description:
			'Once I have as much information as possible on your project.I will create an individual proposal. All proposals will be job completed and not charged by the hours. This means you will have a full overview of the costs and time-frame.',
		headline: 'Proposal',
	},
	{
		id: 3,
		step: 'Step 4',
		description:
			'I will then start to Implement the project with particular emphasis on communication. Through the communication channel of your choice with regular updates.',
	...
	},
	{
		...
		step: 'Step 5',
		description:
			'On completion of the project, the finished project goes through internal quality assurances. Once put through it paces it will be handed over to you the client.',
...
export const Projects = [
	{
		id: 1,
		title: 'Capitals Of The World App',
		image: 'https://i.ibb.co/RHkLybm/quizgameforsite.png',
		intro:
