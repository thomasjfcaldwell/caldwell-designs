export const Experience = [
	{
		id: 0,
		company: 'Easy And Quick Gifts',
		position: 'Web Developer & Owner',
		date: 'September 2021 - present',
		responsibilities:
			'Set up shopify store to receive orders, created merchandise to order using photoshop and illustrator. Designed web banners to advertise merchandise and offers',
		technologies: ['Shopify', 'Photoshop', 'Illustrator'],
	},
	{
		id: 1,
		company: 'Wow Events',
		...
		responsibilities:
			'Planned, designed and developed site to receive bookings for a new service. Created marketing materials for print and integrated 3rd party forms to collect booking information',
		technologies: ['React', 'React-bootstrap', 'google forms'],
	},
	{
		id: 2,
	...
	{
		id: 3,
		company: 'E-Cig Gallery Wholesale',
